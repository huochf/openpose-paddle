# ------------------------------------------------------------------------
# This code is based on Openpose (https://github.com/CMU-Perceptual-Computing-Lab/openpose/blob/master/models/hand/pose_deploy.prototxt)
...
class HandPose(dg.Layer):
    ...
    def __init__(self, ):
        ...
        stage1 = [
            ...
            ('conv6_2_CPM', ([512,  22], 'conv1x1', 'no_relu')),
        ]
        stage1 = make_layers(stage1)
        self.stage1 = dg.Sequential(*stage1)

        self.stage2 = PoseBlock(150, 128, 22, 2, 1)
        self.stage3 = PoseBlock(150, 128, 22, 3, 1)
        self.stage4 = PoseBlock(150, 128, 22, 4, 1)
        self.stage5 = PoseBlock(150, 128, 22, 5, 1)
        self.stage6 = PoseBlock(150, 128, 22, 6, 1)
