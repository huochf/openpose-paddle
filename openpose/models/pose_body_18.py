# ------------------------------------------------------------------------
# This code is based on Openpose (https://github.com/CMU-Perceptual-Computing-Lab/openpose/blob/master/models/pose/coco/pose_deploy_linevec.prototxt)
...
class BodyPose(dg.Layer):
    ...
    def __init__(self, ):
        ...
        PAF_stage1 = [
            ...
            ('conv5_5_CPM_L1', ([512,  38], 'conv1x1', 'no_relu')),
        ]
        ...
        CHM_stage1 = [
            ...
            ('conv5_5_CPM_L2', ([512,  19], 'conv1x1', 'no_relu')),
        ]
        CHM_stage1 = make_layers(CHM_stage1)
        self.CHM_stage1 = dg.Sequential(*CHM_stage1)

        self.PAF_stage2 = PoseBlock(185, 128, 38, 2, 1)
        self.PAF_stage3 = PoseBlock(185, 128, 38, 3, 1)
        self.PAF_stage4 = PoseBlock(185, 128, 38, 4, 1)
        self.PAF_stage5 = PoseBlock(185, 128, 38, 5, 1)
        self.PAF_stage6 = PoseBlock(185, 128, 38, 6, 1)

        self.CHM_stage2 = PoseBlock(185, 128, 19, 2, 2)
        self.CHM_stage3 = PoseBlock(185, 128, 19, 3, 2)
        self.CHM_stage4 = PoseBlock(185, 128, 19, 4, 2)
        self.CHM_stage5 = PoseBlock(185, 128, 19, 5, 2)
        self.CHM_stage6 = PoseBlock(185, 128, 19, 6, 2)
